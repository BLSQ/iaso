# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-09-01 13:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.TextField(choices=[('historic', 'Historic'), ('mobile_backup', 'Mobile backup'), ('pv', 'Pharamcovigilance')], null=True)),
                ...
                ('treatment_result', models.TextField(choices=[('recovered', 'Recovered'), ('healthy', 'Healthy'), ('relapse', 'Relapse'), ('disappeared', 'Disappeared'), ('died', 'Died'), ('transferred', 'Transferred'), ('other', 'Other')], null=True)),
                ...
                ('test_woo', models.NullBooleanField()),
                ('test_maec', models.NullBooleanField()),
                ('test_maect_bc', models.NullBooleanField()),
                ('test_lcr', models.NullBooleanField()),
                ('test_lcr_fr', models.NullBooleanField()),
                ('test_lcr_scm', models.NullBooleanField()),
            ...
            options={
                'permissions': (('import', 'Can import data'), ('export', 'Can export data'), ('export_full', 'Can export the full dataset as csv')),
            },
        ),
    ]
