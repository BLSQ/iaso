...
class EntityDuplicateAnalyzisViewSet(ModelViewSet):
    ...
    def get_permissions(self):
        permission_classes = [permissions.IsAuthenticated, HasPermission(permission.ENTITIES_DUPLICATE_READ)]
        if self.action in ["partial_update", "destroy", "create"]:
            permission_classes += [HasPermission(permission.ENTITIES_DUPLICATE_WRITE)]
