...
class TestAccountDeleteAIApiKey(APITestCase):
    def setUp(self):
        super().setUp()
    ...
    def test_permission(self):
        res = self.client.delete(reverse("accounts-ai-api-key", kwargs={"pk": self.account.pk}))
        ...
        res = self.client.delete(reverse("accounts-ai-api-key", kwargs={"pk": self.other_account.pk}))
    ...
    def test_delete(self):
        ...
        self.assertIsNone(self.account.anthropic_api_key)
