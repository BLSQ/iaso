...
from submissions import submission2xml, org_unit_gps_point, instance_by_LLIN_campaign_form
...
def new_llin_forms():
    forms = [
        ...
        {"name": "Distribution", "xls_file": "distribution.xlsx", "form_id": "cahier_de_distribution_v1.1"},
        {
