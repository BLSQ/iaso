...
router.register(r"orgunittypes", OrgUnitTypeViewSet, basename="orgunittypes_v1")
...
router.register(r"mobile/entitytypes?", MobileEntityTypesViewSet, basename="entitytype_mobile")
...
router.register(r"mobile/reports", MobileReportsViewSet, basename="report_mobile")
