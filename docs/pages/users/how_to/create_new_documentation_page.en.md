...
- use markdown syntax to add the link `![my_image](./create_new_documentation_page/attachments/my_image.png)`
- use an html `img` tag:
```html
<img src="./create_new_documentation_page/attachments/image49.png" />
```
...
```html
<img src="./create_new_documentation_page/attachments/image49.png" style="width:50px;height:50px" />
```
