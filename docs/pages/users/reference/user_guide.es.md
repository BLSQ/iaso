...
![alt text](./user_guide_attachments/iasologin.png)
...
![alt text](<./user_guide_attachments/Web interface intro.jpg>)
...
![alt text](./user_guide_attachments/formsmanagementv2.png)

Los botones a continuación le permiten gestionar los formularios de recolección de datos.

![alt text](./user_guide_attachments/formsbuttons.png)
...
![alt text](./user_guide_attachments/createformv2.png)
...
![alt text](./user_guide_attachments/Formsubmissions.png)
...
![alt text](./user_guide_attachments/downloadsubmissions.png)

También puede verificar los envíos en la vista del mapa, en la que se aplican los filtros. Para asegurarse de tener esta vista de mapa habilitada, asegúrese de haber agregado la función "GPS para cada formulario" al [Proyecto](./iaso_web/Projects) relacionado.

![alt text](./user_guide_attachments/mapviewsubmissions.png)
...
![alt text](./user_guide_attachments/submissionsmanagement.png)

![alt text](./user_guide_attachments/Submissionsbuttons.png)
...
![alt text](./user_guide_attachments/submissionview.png)
...
<img src="./user_guide_attachments/image102.png"
style="width:5.96354in;height:2.29367in" />

<img src="./user_guide_attachments/image71.png"
...
<img src="./user_guide_attachments/image66.png"
...
<img src="./user_guide_attachments/image76.png"
style="width:1.56771in;height:1.65794in" />

**Exportar un envío**

La función de exportación le permite exportar el formulario a DHIS2. Previamente, necesita haber sido mapeado usando la funcionalidad de [mapeo DHIS2](./iaso_web/DHIS2).
...
<img src="./user_guide_attachments/image57.png"
style="width:6.15663in;height:3.40104in" />

<img src="./user_guide_attachments/image7.png"
...
<img src="./user_guide_attachments/image74.png" style="width:6.5in;height:1.75in" />
...
<img src="./user_guide_attachments/image75.png" style="width:6.5in;height:2.59722in" />
...
de DHIS2 correspondiente<img src="./user_guide_attachments/image93.png"
style="width:2.03704in;height:1.83333in" /><img src="./user_guide_attachments/image98.png"
...
<img src="./user_guide_attachments/image115.png"
...
<img src="./user_guide_attachments/image94.png"
...
Haga clic en el botón <img src="./user_guide_attachments/image104.png"
...
<img src="./user_guide_attachments/image17.png" style="width:6.5in;height:2.95833in" />
...
![](<./user_guide_attachments/completeness stats.png>)
...
![alt text](./user_guide_attachments/Completenessmap.png)
...
![alt text](./user_guide_attachments/Orgunitlist.png)

![alt text](./user_guide_attachments/orgunitmap.png)

Los resultados de búsqueda pueden ser exportados en CSV, XLSX o GPKG.

![alt text](<./user_guide_attachments/download orgunits.png>)


Los resultados pueden verse en una lista o en un mapa

<img src="./user_guide_attachments/image35.png"
...
<img src="./user_guide_attachments/image32.png" style="width:6.5in;height:2.875in" />

Se pueden hacer varias búsquedas agregando pestañas a la página con el
botón +. <img src="./user_guide_attachments/image45.png" style="width:7.01017in;height:1.93229in" />

Puede elegir el color de los resultados en el mapa para cada búsqueda.

<img src="./user_guide_attachments/image90.png"
style="width:6.95313in;height:2.9466in" />

 <img src="./user_guide_attachments/image120.png" style="width:6.26042in;height:2.38542in" />
...
<img src="./user_guide_attachments/image16.png" style="width:6.86961in;height:2.80729in" />
...
![alt text](./user_guide_attachments/orgunitdetailsedit.png)
...
![alt text](<./user_guide_attachments/children org units.png>)
...
![alt text](./user_guide_attachments/Orgunitbulkedit.png)
...
<img src="./user_guide_attachments/image44.png" style="width:6.5in;height:2.41667in" />
...
<img src="./user_guide_attachments/image5.png" style="width:6.5in;height:2.29167in" />
...
Los tipos de Unidades Organizacionales son específicos de IASO (es decir, esto no se maneja en DHIS2). Vea la parte sobre [Unidades Organizacionales](./iaso_web/OU) para más detalles sobre qué son los tipos de Unidades Organizacionales.
...
![alt text](./user_guide_attachments/editorgunittype.png)
...
<img src="./user_guide_attachments/image52.png" style="width:6.5in;height:1.86111in" />
...
<img src="./user_guide_attachments/image40.png" style="width:6.5in;height:1.26389in" />
...
![alt text](./user_guide_attachments/registry.png)
...
![alt text](./user_guide_attachments/reviewchangeproposals.png)
...
![alt text](./user_guide_attachments/reviewchanges.png)
...
![alt text](./user_guide_attachments/planninglist.png)

**Crear una Planificación**

Haga clic en "Crear" y verá la ventana a continuación abriéndose:

<img src="./user_guide_attachments/image48.png" style="width:6.5in;height:3.80556in" />
...
![alt text](<./user_guide_attachments/planning assignment.png>)
...
<img src="./user_guide_attachments/image10.png" style="width:2.97396in;height:2.55034in" />
...
<img src="./user_guide_attachments/image73.png" style="width:6.5in;height:2.68056in" />
...
![alt text](./user_guide_attachments/tasks.png)
...
![alt text](./user_guide_attachments/Devices.png)
...
![alt text](./user_guide_attachments/Project.png)
...
![alt text](./user_guide_attachments/featureflags2.png)
...
![alt text](./user_guide_attachments/Createuser.png)
...
![alt text](./user_guide_attachments/Permissions.png)
...
![alt text](./user_guide_attachments/locationrestrict.png)
...
![alt text](./user_guide_attachments/userfilters.png)
...
![alt text](./user_guide_attachments/editusersbulk.png)
...
![alt text](./user_guide_attachments/usersbulkeditactions.png)
...
Desde la página Admin > Roles de usuario, haga clic en "Crear".
 ...
 ![alt text](./user_guide_attachments/userroles.png)
...
![alt text](./user_guide_attachments/Userrolespermissions.png)
...
La noción de Equipos en IASO se usa principalmente para la característica de [Planificación](./iaso_web/Planning). Permite organizar Usuarios en jerarquías de Equipo y asignar actividades de recolección de datos a las geografías relevantes según sea necesario para los propósitos de Planificación.
...
![alt text](./user_guide_attachments/createteam.png)
