...
```html
<!-->Initial value<-->
<img src="./convert_docx_to_md/media/image1.png"style="width:3.02211in;height:0.79688in" />
<!-->Correct value<-->
<img src="./convert_docx_to_md/attachments/image1.png"style="width:3.02211in;height:0.79688in" />
```
