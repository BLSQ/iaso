...
const search = 'ZELDA';
const baseUrl = `${siteBaseUrl}/dashboard/forms/list/accountId/1`;
...
describe('Forms', () => {
    describe('page', () => {
        ...
        it('click on create button should redirect to form creation url', () => {
            ...
            cy.url().should(
                'eq',
                `${siteBaseUrl}/dashboard/forms/detail/formId/0/accountId/1`,
            );
        });
        ...
        describe('Search button', () => {
            ...
            it('action should deep link active search', () => {
                ...
                cy.url().should(
                    'eq',
                    `${siteBaseUrl}/dashboard/forms/list/page/1/search/${search}/accountId/1`,
                );
            });
        });
        describe('Table', () => {
