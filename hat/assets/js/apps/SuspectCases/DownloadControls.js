...
class DownloadControls extends Component {
  ...
  render () {
    ...
    switch (state) {
      case 'show-prepare':
        return (
          <button className='button button--big' onClick={this.downloadHandler}>
      ...
      case 'loading':
        return (
          <button className='button--pressed button--big animation--fade-in' disabled='true'>
      ...
      case 'show-result-link':
        return (
          <a href={resultUrl} className='button--success button--big animation--fade-in'><i className='fa fa-download' />
