...
class CheckVersionAPITestCase(APITestCase):
    ...
    def test_check_version_delete(self):
        ...
        response = self.client.delete("/api/mobile/checkversion/")
    ...
    def test_check_version_put(self):
        ...
        self.client.force_authenticate(self.yoda)
        response = self.client.put("/api/mobile/checkversion/")
        self.assertJSONResponse(response, 405)
    ...
    def test_check_version_post(self):
        ...
        self.client.force_authenticate(self.yoda)
        response = self.client.post("/api/mobile/checkversion/")
        self.assertJSONResponse(response, 405)
    ...
    def test_get_check_version_without_app_id_and_app_version(self):
        ...
        response = self.client.get("/api/mobile/checkversion/")
    ...
    def test_get_check_version_without_app_id(self):
        ...
        response = self.client.get(f"/api/mobile/checkversion/?{APP_VERSION}=1234")
        self.assertJSONResponse(response, 400)
    ...
    def test_get_check_version_without_app_version(self):
        ...
        response = self.client.get(f"/api/mobile/checkversion/?{APP_ID}={self.project_2.app_id}")
        self.assertJSONResponse(response, 400)
    ...
    def test_get_check_version_with_wrong_app_version(self):
        ...
        response = self.client.get(f"/api/mobile/checkversion/?{APP_ID}={self.project_2.app_id}&{APP_VERSION}=123AF")
        self.assertJSONResponse(response, 400)
    ...
    def test_get_check_version_with_nonexisting_project(self):
        ...
        response = self.client.get(f"/api/mobile/checkversion/?{APP_ID}=wrong.project.id&{APP_VERSION}=1000")
    ...
    def test_get_check_version_for_project_with_no_min_version(self):
        ...
        response = self.client.get(f"/api/mobile/checkversion/?{APP_ID}={self.project_1.app_id}&{APP_VERSION}=-1000")
    ...
    def test_get_check_version_for_project_with_min_version_higher_than_provided(self):
        ...
        response = self.client.get(f"/api/mobile/checkversion/?{APP_ID}={self.project_2.app_id}&{APP_VERSION}=1000")
    ...
    def test_get_check_version_for_project_with_min_version_lower_than_provided(self):
        ...
        response = self.client.get(f"/api/mobile/checkversion/?{APP_ID}={self.project_2.app_id}&{APP_VERSION}=5000")
        self.assertJSONResponse(response, 204)
    ...
    def test_get_check_version_for_project_with_min_version_equal_to_than_provided(self):
        ...
        response = self.client.get(f"/api/mobile/checkversion/?{APP_ID}={self.project_2.app_id}&{APP_VERSION}=1234")
        self.assertJSONResponse(response, 204)
