...
class DataSourceSynchronizerTestCase(TestCase):
    """
    Test DataSourceSynchronizer.

    See also `DataSourceSynchronizationModelTestCase`.
    """
    ...
    def test_sort_by_path(self):
        ...
        sorted_diffs = DataSourceSynchronizer.sort_by_path(diffs)
    ...
    def test_parse_date_str(self):
        parsed_date = DataSourceSynchronizer.parse_date_str("2025-11-28")
    ...
    def test_has_group_changes(self):
        ...
        has_group_changes = DataSourceSynchronizer.has_group_changes(comparisons)
