...
describe('WidgetPaperRow', () => {
    it('renders the label', () => {
        renderWithTable(
            <WidgetPaperRow field={{ label: 'Name', value: 'John Doe' }} />,
        );
    ...
    it('renders the value when provided', () => {
        renderWithTable(<WidgetPaperRow field={{ label: 'Age', value: 42 }} />);
    ...
    it('renders the default placeholder when value is falsy and no placeholder is provided', () => {
        renderWithTable(
            <WidgetPaperRow field={{ label: 'Phone', value: null }} />,
        );
    ...
    it('renders the default placeholder when value is undefined and no placeholder is provided', () => {
        renderWithTable(
            <WidgetPaperRow field={{ label: 'Phone', value: undefined }} />,
        );
