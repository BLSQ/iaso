...
from iaso.models import Account, StockImpacts, StockRulesVersionsStatus
...
class StockKeepingUnitSerializerTestCase(TestCase):
    ...
    def setUpTestData(cls):
        cls.account_1 = account_1 = Account.objects.create(name="Test Account")
        cls.account_2 = account_2 = Account.objects.create(name="Forbidden Account")
...
class StockRulesVersionSerializerTestCase(TestCase):
    ...
    def test_serialize_instance(self):
        ...
        self.assertEqual(
            ...
            {
                "name": "Version 1",
                "status": StockRulesVersionsStatus.DRAFT.value,
                "rules": [
                    collections.OrderedDict(
                        {
                    ...
                    collections.OrderedDict(
                        {
                            ...
                            "form": collections.OrderedDict({"id": self.form_1.pk, "name": "Form 1"}),
                            "question": "question_name_2",
                            "impact": StockImpacts.SUBTRACT.value,
                            "order": 0,
                            "created_at": 1755608400.0,
                            "created_by": collections.OrderedDict({"id": self.user.pk, "username": "User 1"}),
                            "updated_at": 1755608400.0,
    ...
    def _update_from_status_to_status(self, from_status: StockRulesVersionsStatus, to_status: StockRulesVersionsStatus):
        request = APIRequestFactory().get("/")
        request.user = self.user
    ...
    def test_update_from_draft_to_draft(self):
        self._update_from_status_to_status(StockRulesVersionsStatus.DRAFT, StockRulesVersionsStatus.DRAFT)

    def test_update_from_draft_to_published(self):
        self._update_from_status_to_status(StockRulesVersionsStatus.DRAFT, StockRulesVersionsStatus.PUBLISHED)

    def test_update_from_draft_to_unpublished(self):
        self._update_from_status_to_status(StockRulesVersionsStatus.DRAFT, StockRulesVersionsStatus.UNPUBLISHED)

    def test_update_from_published_to_published(self):
        self._update_from_status_to_status(StockRulesVersionsStatus.PUBLISHED, StockRulesVersionsStatus.PUBLISHED)

    def test_update_from_published_to_unpublished(self):
        self._update_from_status_to_status(StockRulesVersionsStatus.PUBLISHED, StockRulesVersionsStatus.UNPUBLISHED)

    def test_update_from_published_to_draft(self):
        try:
            self._update_from_status_to_status(StockRulesVersionsStatus.PUBLISHED, StockRulesVersionsStatus.DRAFT)
    ...
    def test_update_from_unpublished_to_unpublished(self):
        self._update_from_status_to_status(StockRulesVersionsStatus.UNPUBLISHED, StockRulesVersionsStatus.UNPUBLISHED)

    def test_update_from_unpublished_to_published(self):
        self._update_from_status_to_status(StockRulesVersionsStatus.UNPUBLISHED, StockRulesVersionsStatus.PUBLISHED)

    def test_update_from_unpublished_to_draft(self):
        try:
            self._update_from_status_to_status(StockRulesVersionsStatus.UNPUBLISHED, StockRulesVersionsStatus.DRAFT)
            raise self.failureException("It should have thrown an exception")
        except ValidationError as e:
