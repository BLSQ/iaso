...
export default function datasApp(appConfig, element, baseUrl) {
    ...
    const routes = [
        <Route
            ...
            '(/search_prename/:search_prename)(/search_lastname/:search_lastname)(/teams/:teams)(/coordination_id/:coordination_id)(/back/:back)' +
        ...
        <Route
            ...
            '(/device_id/:device_id)(/pictures/:pictures)(/videos/:videos)(/anonymous/:anonymous)(/back/:back)'}
