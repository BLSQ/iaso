...
![setup account api](./setup_an_empty_iaso_account_attachments/setupaccount_api.png)
...
![duplicate_admin](./setup_an_empty_iaso_account_attachments/duplicate_admin.png)
...
Evite hacer los siguientes pasos con el admin django, ya que puede llevar a accidentes industriales: el usuario puede estar vinculado a una cuenta/proyecto totalmente diferente y podría terminar con la pirámide de un proyecto llena de orgunits de otro país.
 ...
 ![menu](./setup_an_empty_iaso_account_attachments/menu.png)
...
![project](./setup_an_empty_iaso_account_attachments/project.png)
...
Haga que la fuente sea la predeterminada 
 ...
 ![update_source](./setup_an_empty_iaso_account_attachments/update_source.png)
...
![sourceversion](./setup_an_empty_iaso_account_attachments/sourceversion.png)
...
![update_pyramid](./setup_an_empty_iaso_account_attachments/update_pyramid.png)
