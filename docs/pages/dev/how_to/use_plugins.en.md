...
The plugin system includes support for translations. For a comprehensive guide on the translation system, see [Using Translations in Iaso Frontend](./use_translations.en.md).
