...
def bulk_create_user_csv_file_upload_to_for_file_field(bulk_create, filename):
...
class BulkCreateUserCsvFile(models.Model):
    file = models.FileField(upload_to=bulk_create_user_csv_file_upload_to_for_file_field, blank=False, null=False)
