...
class QCStatsViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        image_mismatches = Check.objects.exclude(result=F('test__result')).exclude(test__image=None)
        video_mismatches = Check.objects.exclude(result=F('test__result')).exclude(test__video=None)
