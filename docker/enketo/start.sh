...
# IASO : This is a copy of the default enketo start.sh
# the only modification done is to add `npm install node-sass`
# which was missing in the  3.03  dockerimage. Remove when it's not needed anymore
