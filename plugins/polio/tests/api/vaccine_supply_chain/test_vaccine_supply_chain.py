...
class VaccineSupplyChainAPITestCase(BaseVaccineSupplyChainAPITestCase):
    ...
    def test_pre_alerts_permissions(self):
        ...
        response = self.client.post(self.BASE_URL + f"{request_form.id}/add_pre_alerts/", data=pre_alert_data, format="json")
        self.assertEqual(response.status_code, 201)
        ...
        response = self.client.patch(self.BASE_URL + f"{request_form.id}/update_pre_alerts/", update_data, format="json")
        self.assertEqual(response.status_code, 200)
    ...
    def test_arrival_reports_permissions(self):
        ...
        # Admin can delete regardless of time passed
        response = self.client.delete(self.BASE_URL + f"{request_form.id}/delete_arrival_reports/?id={arrival_report_id}")
        self.assertEqual(response.status_code, 204)
