...
3.  Run the Django server in a first terminal (this will run DB migrations)

        docker compose up iaso

4.  Run a worker in a second terminal
...
6.  Prepare the setuper (it requires a local Python 3)
