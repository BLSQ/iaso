...
MOVED_PAGES = [
    ...
    ('pages/dev/how_to/attach_file_to_forms', 'pages/dev/how_to', 'attach_file_to_forms.html', 'attach_file_to_forms.html'),
    ('pages/dev/how_to/build_odk_preview', 'pages/dev/how_to', 'build_odk_preview.html', 'build_odk_preview.html'),
    ('pages/dev/how_to/configure_black_on_vsc', 'pages/dev/how_to', 'configure_black_on_vsc.html', 'configure_black_on_vsc.html'),
    ('pages/dev/how_to/contribute', 'pages/dev/how_to', 'contribute.html', 'contribute.html'),
    ('pages/dev/how_to/create_entities_in_web_ui', 'pages/dev/how_to', 'create_entities_in_web_ui.html', 'create_entities_in_web_ui.html'),
    ('pages/dev/how_to/create_entity_workflow', 'pages/dev/how_to', 'create_entity_workflow.html', 'create_entity_workflow.html'),
    ('pages/dev/how_to/create_forms_for_entities', 'pages/dev/how_to', 'create_forms_for_entities.html', 'create_forms_for_entities.html'),
    ('pages/dev/how_to/create_mobile_reports', 'pages/dev/how_to', 'create_mobile_reports.html', 'create_mobile_reports.html'),
    ('pages/dev/how_to/create_registry_in_web_ui', 'pages/dev/how_to', 'create_registry_in_web_ui.html', 'create_registry_in_web_ui.html'),
    ...
    ('pages/dev/how_to/exclude_featureflag_related_module', 'pages/dev/how_to', 'exclude_featureflag_related_module.html', 'exclude_featureflag_related_module.html'),
    ('pages/dev/how_to/hot_fix', 'pages/dev/how_to', 'hot_fix.html', 'hot_fix.html'),
    ('pages/dev/how_to/iaso_special_question_names', 'pages/dev/how_to', 'iaso_special_question_names.html', 'iaso_special_question_names.html'),
    ('pages/dev/how_to/iaso_specific_intents', 'pages/dev/how_to', 'iaso_specific_intents.html', 'iaso_specific_intents.html'),
    ('pages/dev/how_to/manually_test_enketo', 'pages/dev/how_to', 'manually_test_enketo.html', 'manually_test_enketo.html'),
    ('pages/dev/how_to/openhexa-integration', 'pages/dev/how_to', 'openhexa-integration.html', 'openhexa-integration.html'),
    ('pages/dev/how_to/planning-pipeline-integration', 'pages/dev/how_to', 'planning-pipeline-integration.html', 'planning-pipeline-integration.html'),
    ...
    ('pages/dev/reference/data_model_glossary', 'pages/dev/reference', 'data_model_glossary.html', 'data_model_glossary.html'),
    ...
    ('pages/dev/reference/front-end_reference', 'pages/dev/reference', 'front-end_reference.html', 'front-end_reference.html'),
    ('pages/dev/reference/guidelines/api', 'pages/dev/reference/guidelines', 'api_synchronization.html', 'api_synchronization.html'),
    ...
    ('pages/dev/reference/sql_dashboard', 'pages/dev/reference', 'SQL_Dashboard_feature.html', 'SQL_Dashboard_feature.html'),
    ('pages/dev/reference/vector_control', 'pages/dev/reference', 'vector_control.html', 'vector_control.html'),
    ('pages/users/how_to/convert_docx_to_md', 'pages/users/how_to', 'convert_docx_to_md.html', 'convert_docx_to_md.html'),
    ('pages/users/how_to/create_new_documentation_page', 'pages/users/how_to', 'create_new_documentation_page.html', 'create_new_documentation_page.html'),
    ('pages/users/how_to/edit_documentation', 'pages/users/how_to', 'edit_documentation.html', 'edit_documentation.html'),
    ('pages/users/how_to/run_ETL', 'pages/users/how_to', 'run_ETL.html', 'run_ETL.html'),
    ('pages/users/how_to/setup_an_empty_iaso_account', 'pages/users/how_to', 'setup_an_empty_iaso_account.html', 'setup_an_empty_iaso_account.html'),
    ('pages/users/how_to/setup_dhis2_login_in_iaso', 'pages/users/how_to', 'setup_dhis2_login_in_iaso.html', 'setup_dhis2_login_in_iaso.html'),
