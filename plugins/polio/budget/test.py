...
class BudgetProcessAPITestCase(APITestCase):
    ...
    def setUpTestData(cls) -> None:
        ...
        cls.test_user = cls.create_user_with_profile(username="test_user", account=cls.account, permissions=["iaso_polio_budget"])
        cls.test_user_no_permission = cls.create_user_with_profile(username="test_user_no_permission", account=cls.account)
