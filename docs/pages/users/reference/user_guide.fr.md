...
![alt text](./user_guide_attachments/Loginiasofr.png)
...
![alt text](./user_guide_attachments/Webinterfaceintrofr.png)

## Gérer les formulaires de collecte de données

### Créer votre formulaire avec l'IA
...
![alt text](./user_guide_attachments/formsbuttonsfr.png)
...
![alt text](./user_guide_attachments/createformv2fr.png)
...
![alt text](./user_guide_attachments/Formsubmissionsfr.png)
...
![alt text](./user_guide_attachments/downloadsubmissionsfr.png)

Vous pouvez également vérifier les soumissions dans la vue cartographique. Les filtres appliqués s'y reflèteront également. Pour vous assurer que cette vue cartographique est activée, veillez à avoir ajouté l'indicateur de fonctionnalité "GPS pour chaque formulaire" au [Projet](./iaso_web/Projects) concerné.

![alt text](./user_guide_attachments/mapviewsubmissionsfr.png)
...
![alt text](./user_guide_attachments/submissionsmanagementfr.png)

![alt text](./user_guide_attachments/Submissionsbuttonsfr.png)
...
![alt text](./user_guide_attachments/submissionviewfr.png)
...
La fonction d'exportation permet d'exporter le formulaire vers DHIS2. Au préalable, il doit avoir été mappé à l'aide de la fonctionnalité de [mapping DHIS2](./iaso_web/DHIS2) functionality. 
...
![](<./user_guide_attachments/completeness statsfr.png>)
...
![alt text](./user_guide_attachments/Completenessmapfr.png)
...
![alt text](./user_guide_attachments/Orgunitlistfr.png)

![alt text](./user_guide_attachments/orgunitmapfr.png)

Les résultats de la recherche peuvent être exportés en CSV, XLSX ou GPKG.

![alt text](<./user_guide_attachments/download orgunitsfr.png>)
...
![alt text](./user_guide_attachments/orgunitdetailseditfr.png)
...
![alt text](<./user_guide_attachments/children org unitsfr.png>)
...
![alt text](./user_guide_attachments/Orgunitbulkeditfr.png)
...
Les types d'unités d'organisation sont spécifiques à IASO (c'est-à-dire qu'ils ne sont pas gérés dans DHIS2). Consultez la section sur les [Unités d'Organisation](./iaso_web/OU) pour plus de détails sur ce que sont les types d'unités d'organisation.
...
![alt text](./user_guide_attachments/editorgunittypefr.png)
...
![alt text](./user_guide_attachments/registryfr.png)
...
![alt text](./user_guide_attachments/reviewchangeproposalsfr.png)
...
![alt text](./user_guide_attachments/reviewchangesfr.png)
...
![alt text](<./user_guide_attachments/planning assignmentfr.png>)
...
![alt text](./user_guide_attachments/tasksfr.png)
...
![alt text](./user_guide_attachments/Devicesfr.png)
...
![alt text](./user_guide_attachments/featureflags2fr.png)
...
![alt text](./user_guide_attachments/Createuserfr.png)
...
![alt text](./user_guide_attachments/Permissionsfr.png)
...
![alt text](./user_guide_attachments/locationrestrictfr.png)
...
![alt text](./user_guide_attachments/userfiltersfr.png)
...
![alt text](./user_guide_attachments/editusersbulkfr.png)
...
![alt text](./user_guide_attachments/usersbulkeditactionsfr.png)
...
Depuis le menu Admin > Rôles utilisateur, cliquez sur "Créer".
 ...
 ![alt text](./user_guide_attachments/userrolesfr.png)
...
![alt text](./user_guide_attachments/Userrolespermissionsfr.png)
...
La notion d'équipes dans IASO est principalement utilisée pour la fonctionnalité de [Planning](./iaso_web/Planning). Elle permet d'organiser les utilisateurs en hiérarchies d'équipes et d'assigner des activités de collecte aux zones géographiques pertinentes pour les besoins de planification.
...
![alt text](./user_guide_attachments/createteamfr.png)
