...
![](./iaso_mobile_attachments/homepageiasoEN.png)
![](./iaso_mobile_attachments/iasomenuEN.png)

- Desde la página de Proyectos, haz clic en el código QR al final de la línea correspondiente.
![](./iaso_mobile_attachments/qrcodeiasoEN.png)
- Escanea el código QR con la aplicación móvil IASO.
![](./iaso_mobile_attachments/iasoqrcodeEN1.png)
![](./iaso_mobile_attachments/iasoqrcodeEN2.png)
- ¡Todo listo!
...
![](./iaso_mobile_attachments/mobileappbuttons.png)
...
![alt text](./iaso_mobile_attachments/datacollection.png)
...
![alt text](./iaso_mobile_attachments/uploaddata.png)
