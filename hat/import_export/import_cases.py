...
from hat.cases.event_log import (
    EventFile,
    EventStats,
    log_cases_file_import,
    cases_file_exists,
)
...
def import_cases_file(orgname: str, filename: str) -> ImportResult:
    ...
    try:
        ...
        file = EventFile(name=orgname, hash=file_hash, contents=data)
...
def import_historic_data(
    orgname: str, tables: Dict[str, str], file_hash: str
) -> EventStats:
