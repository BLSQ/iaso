...
from iaso.models import Account, EntityType, Form, Project
from iaso.models.microplanning import MissionEntityType, MissionType
...
class MissionEntityTypeAPICreateTestCase(SwaggerTestCaseMixin, APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.et = EntityType.objects.create(name="et", account=cls.account, reference_form=cls.form_1)
        cls.et_2 = EntityType.objects.create(name="et2", account=cls.account, reference_form=cls.form_1)
        cls.et_3 = EntityType.objects.create(name="et3", account=cls.account, reference_form=cls.form_2)
