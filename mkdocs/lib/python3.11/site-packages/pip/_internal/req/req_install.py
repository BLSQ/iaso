...
class InstallRequirement:
    ...
    def install(
        ...
        try:
            if self.legacy_install_reason is not None and self.legacy_install_reason.emit_before_install:
        ...
        if success and self.legacy_install_reason is not None and self.legacy_install_reason.emit_after_success:
            self.legacy_install_reason.emit_deprecation(self.name)
