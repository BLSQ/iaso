...
This document explains how to create ODK forms for [entities](../../users/reference/iaso_concepts.en.md#entities) and their [workflows](../../users/reference/iaso_concepts.en.md#workflows).

## The entity's profile

The profile (or reference form) is an [ODK form](../../users/reference/iaso_concepts.en.md#questionnaires-or-xls-data-collection-forms) that contains all the entity's information.
