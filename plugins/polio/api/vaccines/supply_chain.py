...
class NestedVaccinePreAlertSerializerForPatch(NestedVaccinePreAlertSerializerForPost):
    ...
    class Meta(NestedVaccinePreAlertSerializerForPost.Meta):
        fields = NestedVaccinePreAlertSerializerForPost.Meta.fields + ["id", "can_edit", "scan_result", "scan_timestamp"]
...
class VaccineRequestFormViewSet(ModelViewSet):
    ...
    def get_serializer_class(self):
        ...
        if self.action in ["get_pre_alerts", "get_arrival_reports", "delete_pre_alerts", "delete_arrival_reports"]:
            return None
