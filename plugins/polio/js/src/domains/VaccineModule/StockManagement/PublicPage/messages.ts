...
const MESSAGES = defineMessages({
    countryStockCards: {
        id: 'iaso.polio.title.countryStockCards',
        defaultMessage: 'Country stock cards',
    },
    en: { id: 'iaso.users.label.english', defaultMessage: 'English' },
    fr: { id: 'iaso.users.label.french', defaultMessage: 'French' },
    country: {
    ...
    actionType: {
        id: 'iaso.label.actionType',
        defaultMessage: 'Action type',
    },
    vialsType: {
        id: 'iaso.label.vialsType',
        defaultMessage: 'Vials type',
    },
    forma_vials_used: {
    ...
    incident_report: {
        id: 'iaso.polio.label.incidentReport',
        defaultMessage: 'Incident report',
    },
    destruction_report: {
        id: 'iaso.polio.label.destructionReport',
        defaultMessage: 'Destruction report',
    },
    earmarked_stock__returned: {
        id: 'iaso.polio.label.earmarked_stock__returned',
        defaultMessage: 'Earmaked stock - Returned',
    },
    earmarked_stock__created: {
        id: 'iaso.polio.label.earmarked_stock__created',
        defaultMessage: 'Earmaked stock - Created',
    },
    earmarked_stock__used: {
        id: 'iaso.polio.label.earmarked_stock__used',
        defaultMessage: 'Earmaked stock - Used',
    },
    po_action_type: {
