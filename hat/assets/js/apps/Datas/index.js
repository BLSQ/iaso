...
export default function datasApp(appConfig, element, baseUrl) {
    ...
    const routes = [
        <Route
            ...
            '(/located/:located)(/test_type/:test_type)(/tester_type/:tester_type)(/device_id/:device_id)(/pictures/:pictures)(/videos/:videos)'}
            component={CasesPage}
        />,
        <Route
        ...
        <Route
            ...
            '(/device_id/:device_id)(/pictures/:pictures)(/videos/:videos)'}
        ...
        <Route
            ...
            '(/prov_id/:prov_id)(/ZS_id/:ZS_id)(/AS_id/:AS_id)(/vil_id/:vil_id)(/device_id/:device_id)(/pictures/:pictures)(/videos/:videos)'}
            component={PatientDetailPage}
        />,
        <Route
            ...
            '(/search_prename/:search_prename)(/search_lastname/:search_lastname)(/teams/:teams)(/coordination_id/:coordination_id)' +
            '(/search_mother_name/:search_mother_name)(/test_type/:test_type)'}
        ...
        <Route
            ...
            '/page/:page(/workzone_id/:workzone_id)(/province_id/:province_id)(/zs_id/:zs_id)(/as_id/:as_id)' +
