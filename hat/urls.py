...
# if settings.DISABLE_PASSWORD_LOGINS:
#     urlpatterns = urlpatterns + [
#         # FIXME: Temporary fix in the unlikely event someone navigates to the /accounts/login and accounts/admin/login urls (generated by inclide lines 38-39)
#         path(
#             "accounts/admin/login/", TemplateView.as_view(template_name="iaso/disabled_password_login.html"), name="login-iaso"
#         ),
#         path("accounts/login/", TemplateView.as_view(template_name="iaso/disabled_password_login.html"), name="login-iaso"),
#         # end fix
#         path(
#             "admin/login/", TemplateView.as_view(template_name="iaso/disabled_password_login.html"), name="login-iaso"
#         ),
