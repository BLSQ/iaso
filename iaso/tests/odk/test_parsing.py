...
import json
from iaso.odk import parse_xls_form, XMLForm, ParsingError, to_questions_by_name
...
class ParsingTestCase(SimpleTestCase):
    def test_parse_xls_form_valid(self):
        ...
        self.assertIn(
            ...
            xml_form.file_content.decode("utf-8"),
        )
    ...
    def test_parse_xls_form_autogenerate_first_version(self, now_mock):
        ...
        with open(
            "iaso/tests/fixtures/odk_form_valid_sample1_no_version.xls", "rb"
        ) as xls_file:
            xml_form = parse_xls_form(xls_file)
