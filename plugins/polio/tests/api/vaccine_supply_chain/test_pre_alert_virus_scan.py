...
class PreAlertVirusScanAPITestCase(BaseVaccineSupplyChainAPITestCase):
    ...
    def test_create_pre_alert_with_safe_and_infected_files(self, mock_get_scanner):
        ...
        pre_alert_1 = pm.VaccinePreAlert.objects.filter(po_number=new_pre_alert_1_po_number, request_form=request_form.id).order_by("-id").first()
        ...
        pre_alert_2 = pm.VaccinePreAlert.objects.filter(po_number=new_pre_alert_2_po_number, request_form=request_form.id).order_by("-id").first()
    ...
    def test_create_pre_alert_without_scanning(self):
        ...
        pre_alert = pm.VaccinePreAlert.objects.filter(po_number=new_pre_alert_po_number, request_form=request_form.id).order_by("-id").first()
