...
class QualityDashboard extends React.Component {
    ...
    updateDashboardInfos() {
        ...
        this.props.getDashboardInfos(url).then((response) => {
            this.setState({
            ...
            <div className="widget__container">
                ...
                <div className="widget__header">
                    <h2 className="widget__heading">
                        ...
                        <div className="filter__container__select date-select">
                            <label htmlFor="date-from" className="filter__container__select__label">
                        ...
                        <div className="filter__container__select date-select">
                            <label htmlFor="date-to" className="filter__container__select__label">
                                <i className="fa fa-calendar" />
                                <FormattedMessage id="statspage.label.dateto" defaultMessage="To" />
                            </label>
                            <DatePicker
                                dateFormat={this.state.dateFormat}
                                dateFormatCalendar={this.state.dateFormat}
                ...
                <div className="widget__content--flex">
                    <div className="quality-control-element">
                        ...
                        <p>
                            {`${this.state.videos.no_checks_count} `}
                            <FormattedMessage
                        ...
                        <p>
                            {`${this.state.videos.checks_count} `}
                            <FormattedMessage
                                id="quality.label.checked"
                                defaultMessage="vérifiées"
                            />
                        </p>
                        <p className={this.state.videos.mismatch_count > 0 ? 'with-problems' : ''}>
                            {`${this.state.videos.mismatch_count} `}
                            <FormattedMessage
                        ...
                        {
                            this.state.videos.no_checks_count > 0 &&
                    ...
                    <div className="quality-control-element">
                        ...
                        <p>
                            {`${this.state.images.no_checks_count} `}
                            <FormattedMessage
                                id="quality.label.tockeck"
                                defaultMessage="à vérifier"
                            />
                        ...
                        <p>
                            {`${this.state.images.checks_count} `}
                            <FormattedMessage
                                id="quality.label.checked"
                                defaultMessage="vérifiées"
                            />
                        </p>
                        <p className={this.state.images.mismatch_count > 0 ? 'with-problems' : ''}>
                            {`${this.state.images.mismatch_count} `}
                            <FormattedMessage
                                id="quality.label.withproblems"
                                defaultMessage="avec problèmes"
                            />
                        ...
                        {
                            this.state.images.no_checks_count > 0 &&
...
const MapDispatchToProps = dispatch => ({
    ...
    getDashboardInfos: url => getRequest(url, dispatch),
});
