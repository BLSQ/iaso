...
As explained in [Create forms for entities](./create_forms_for_entities.en.md), 
[entities](../../users/reference/iaso_concepts.en.md#entities) are represented by their profile's 
submission, and are changed through follow-up forms. Yet, to make this work, we need to create a 
[workflow](../../users/reference/iaso_concepts.en.md#workflows) that defines which follow-up forms are
...
![Entity type actions](./create_entity_workflow_attachments/entity_type_actions.png)

There, you can create a new workflow from scratch, open an existing one, or duplicate an existing one:

![Entity type workflows screen](./create_entity_workflow_attachments/entity_type_workflows.en.png)
...
![Workflow edition screen](./create_entity_workflow_attachments/workflow_edition.en.png)
...
![Follow-up edition](./create_entity_workflow_attachments/entity_type_follow_up_edition.en.png)
...
![Change edition](./create_entity_workflow_attachments/entity_type_change_edition.en.png)
