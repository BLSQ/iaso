...
token = auth_response.split("csrftoken=")[1].split(";")[0]
...
if args.localuser and args.localpwd:
    ...
    local_auth_response = local_auth_response.decode("UTF-8")
    local_token = local_auth_response.split("csrftoken=")[1].split(";")[0]
    ...
    for store in response:
        ...
        command = [
            ...
            "POST",
            "-H",
            f"Authorisation: Bearer {local_token}",
            "-H",
            "Content-Type: application/json",
            "-u",
