...
class DownloadControls extends Component {
  ...
  render () {
    ...
    switch (state) {
      case 'show-prepare':
        return <button className='button button--big' onClick={this.downloadHandler}><i className='fa fa-clock-o' /><FormattedMessage id='download.prepare' defaultMessage='Click here to prepare download' /></button>
      case 'loading':
