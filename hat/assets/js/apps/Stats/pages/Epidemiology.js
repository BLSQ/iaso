...
export class Epidemiology extends Component {
    componentDidMount() {
        const {
            params: {
                province_id,
...
const EpidemiologyWithIntl = injectIntl(Epidemiology);

export default connect(MapStateToProps, MapDispatchToProps)(EpidemiologyWithIntl);
