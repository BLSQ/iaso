...
const MESSAGES = defineMessages({
    ...
    ready: {
        ...
        id: 'iaso.label.instanceStatus.ready',
    },
    readyMulti: {
        defaultMessage: 'Ready',
    ...
    error: {
        ...
        id: 'iaso.label.instanceStatus.error',
    },
    errorMulti: {
    ...
    exported: {
        ...
        id: 'iaso.label.instanceStatus.exported',
    },
    exportedMulti: {
        defaultMessage: 'Exported',
