...
from plugins.polio.api.vaccines.repository import VaccineReportingViewSet
...
router.register(r"polio/vaccine/repository", VaccineReportingViewSet, basename="vaccine_repository")
router.register(
