...
![Periodic tasks section](./run_ETL_attachments/Periodic-Tasks.png)

You will get a list of scheduled tasks:

![Periodic tasks List](./run_ETL_attachments/Periodic-task-List.png)
...
![Add periodical task Button](./run_ETL_attachments/Add-periodical-task-Button.png)

You will get a form to create/edit a periodic task like the ETL task:

![Period task forms](./run_ETL_attachments/Periodic-task-Iaso-Form.png)
...
![Run Period task](./run_ETL_attachments/Select-periodic-task-to-run.png)


Then click on the **Go** button:

![Run ETL Period task](./run_ETL_attachments/Run-periodic-task.png)
...
![Task results](./run_ETL_attachments/Task-results-list.png)
...
![Beneficiary](./run_ETL_attachments/Beneficiary.png)
...
![Journey](./run_ETL_attachments/Journey.png)
...
![Visit](./run_ETL_attachments/Visits.png)
...
![Steps](./run_ETL_attachments/Steps.png)
...
![Monthly Statistics](./run_ETL_attachments/Monthly-statistics.png)
