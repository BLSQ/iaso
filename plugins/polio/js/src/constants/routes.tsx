...
import { BUDGET, BUDGET_ADMIN, NOTIFICATION, POLIO, POLIO_ADMIN, STOCK_MANAGEMENT_WRITE, STOCK_MANGEMENT_READ, SUPPLYCHAIN_READ, SUPPLYCHAIN_WRITE } from './permissions';
import { AnonymousRoutePath, RoutePath } from '../../../../../hat/assets/js/apps/Iaso/constants/routes';

// We store the path in a variable so we can import it and use its permissions
export const campaignsPath :RoutePath =  {
    baseUrl: baseUrls.dashboard,
    routerUrl: `${baseUrls.dashboard}/*`,
    element:  <Dashboard   />,
...
export const imPath :RoutePath =    {
    baseUrl: baseUrls.im,
    routerUrl:`${baseUrls.im}/*`,
    element:  <ImStats />,
    permissions: [POLIO,POLIO_ADMIN],
}
