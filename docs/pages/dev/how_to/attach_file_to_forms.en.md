...
In [ODK forms](../../users/reference/iaso_concepts.en.md#questionnaires-or-xls-data-collection-forms), 
...
After you have successfully [created your form in the web interface](../../users/reference/user_guide.en.md#createupload-a-data-collection-form),
go to the details of your form, where you can see all the versions.

![Form details](./attach_file_to_forms_attachments/form_details.en.png)

Select the tab "**ATTACHMENTS**" and click on "**ADD/UPDATE**".

![Form attachments](./attach_file_to_forms_attachments/form_attachments.en.png)

You will be able to upload your file.

![Add or update attachment](./attach_file_to_forms_attachments/add_or_update.en.png)
