...
export const useGetForm = (
    ...
    fields = 'id,name,org_unit_types,projects,period_type,derived,single_per_period,periods_before_allowed,periods_after_allowed,device_field,location_field,label_keys,possible_fields,legend_threshold,change_request_mode',
) => {
    return useSnackQuery({
        queryKey: ['forms', formId],
        queryFn: () => getRequest(`/api/forms/${formId}/?fields=${fields}`),
        options: {
