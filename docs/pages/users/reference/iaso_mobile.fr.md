...
L'application mobile IASO doit être configurée sur la partie web avant utilisation (voir la section “Projet”). Certaines options doivent être activées ou désactivées selon votre usage de IASO.
...
![](./iaso_mobile_attachments/menuiaso.png)
![](./iaso_mobile_attachments/homepageiaso.png)

- Cliquez sur l'icône du QR code à droite de la ligne correspondant à votre Projet.
![](./iaso_mobile_attachments/iasomobileapplicationsetup2.png)
...
![](./iaso_mobile_attachments/mobileappbuttonsfr.png)
...
![alt text](./iaso_mobile_attachments/datacollectionfr.png)
...
![alt text](./iaso_mobile_attachments/uploaddatafr.png)
...
![alt text](./iaso_mobile_attachments/sendserver.png)
