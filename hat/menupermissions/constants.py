...
MODULES = [
    {
        ...
        "es_name": "Recopilación de datos - Formularios",
    },
    {"name": "Default", "codename": "DEFAULT", "fr_name": "Par défaut", "es_name": "Por defecto"},
    {"name": "DHIS2 mapping", "codename": "DHIS2_MAPPING", "fr_name": "Mappage DHIS2", "es_name": "Mapeo DHIS2"},
    {
        "name": "Embedded links",
        "codename": "EMBEDDED_LINKS",
        "fr_name": "Liens intégrés",
        "es_name": "Enlaces integrados",
    },
    {"name": "Entities", "codename": "ENTITIES", "fr_name": "Entités", "es_name": "Entidades"},
    {
        "name": "External storage",
        "codename": "EXTERNAL_STORAGE",
        "fr_name": "Stockage externe",
        "es_name": "Almacenamiento externo",
    },
    {"name": "Planning", "codename": "PLANNING", "fr_name": "Planification", "es_name": "Planificación"},
    {
        "name": "Polio project",
        "codename": "POLIO_PROJECT",
        "fr_name": "Projet Polio",
        "es_name": "Proyecto Polio",
    },  # can't be extracted yet because it generates migrations
    {"name": "Registry", "codename": "REGISTRY", "fr_name": "Registre", "es_name": "Registro"},
    {"name": "Payments", "codename": "PAYMENTS", "fr_name": "Paiements", "es_name": "Pagos"},
    {
        "name": "Completeness per Period",
        "codename": "COMPLETENESS_PER_PERIOD",
        "fr_name": "Complétude par période",
        "es_name": "Completitud por período",
    },
    {
        "name": "Trypelim project",
        "codename": "TRYPELIM_PROJECT",
        "fr_name": "Projet Trypelim",
        "es_name": "Proyecto Trypelim",
    },
    {
        "name": "Data validation",
        "codename": "DATA_VALIDATION",
        "fr_name": "Validation des données",
        "es_name": "Validación de datos",
    },
]
