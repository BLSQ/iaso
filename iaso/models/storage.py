...
class StorageDevice(models.Model):
    ...
    account = models.ForeignKey("iaso.Account", on_delete=models.PROTECT)
    ...
    org_unit = models.ForeignKey("iaso.OrgUnit", on_delete=models.SET_NULL, null=True, blank=True)
    entity = models.ForeignKey("iaso.Entity", on_delete=models.SET_NULL, null=True, blank=True)
...
class StorageLogEntry(models.Model):
    ...
    instances = models.ManyToManyField("iaso.Instance", blank=True, related_name="storage_log_entries")
    org_unit = models.ForeignKey("iaso.OrgUnit", on_delete=models.SET_NULL, null=True, blank=True)
    entity = models.ForeignKey("iaso.Entity", on_delete=models.SET_NULL, null=True, blank=True)
...
class StoragePassword(models.Model):
    ...
    project = models.ForeignKey("iaso.Project", on_delete=models.CASCADE, related_name="storage_passwords")
