    ...
    return (
      <div>
        <div className='filter__container'>
          ...
          <div className='filter__container__select'>
            <label htmlFor='location' className='filter__container__select__label'><i className='fa fa-globe' /><FormattedMessage id='monthlyreport.select.location' defaultMessage='Location' /></label>
