...
- use markdown syntax to add the link `![my_image](./edit_documentation/attachments/my_image.png)`
- use an html `img` tag:
```html
<img src="./edit_documentation/attachments/image49.png" />
```
...
```html
<img src="./edit_documentation/attachments/image49.png" style="width:50px;height:50px" />
