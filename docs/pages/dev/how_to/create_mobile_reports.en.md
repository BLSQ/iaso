...
You can find the documentation for that in the sections [Create forms for entities](./create_forms_for_entities.en.md) and [Create an entity workflow](./create_entity_workflow.en.md#workflows).
...
![See reports](./create_mobile_reports_attachments/report_link.png)


In your Chrome browser, enter the following URL: `chrome://inspect/`, then inspect link:

![Chrome Inspect](./create_mobile_reports_attachments/inspect_link.png)
...
![Code Structure](./create_mobile_reports_attachments/mobile-report-code-structure.png)
...
![Report navigation](./create_mobile_reports_attachments/mobile-report-screen.gif)
...
![See reports](./create_mobile_reports_attachments/report-access-from-mobile-app.gif)