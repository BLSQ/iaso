...
You can also check the submissions on the map view, on which the filters apply. To make sure to have this map view enabled, make sure you have added the feature flag "GPS for each form" to the related [Project](./iaso_web/Projects).
...
The export function allows you to export the form to DHIS2. Beforehand, it needs to have been mapped using the [DHIS2 mapping](./iaso_web/DHIS2) functionality. 
...
element<img src="./user_guide_attachments/image93.png"
...
Click on the <img src="./user_guide_attachments/image104.png"
...
button. <img src="./user_guide_attachments/image45.png" style="width:7.01017in;height:1.93229in" />
...
Organization Unit types are specific to IASO (i.e. this is not handled in DHIS2). See the part about [Organization Units](./iaso_web/OU) for more details on what Organization Unit types are.
...
The notion of Teams in IASO is used mainly for the [Planning](./iaso_web/Planning) feature. It allows to organize Users in Team hierarchies and assign data collection activities to the relevant geographies as needed for the Planning purposes. 
