...
![IASO homepage](./iaso_mobile_attachments/homepageiasoEN.png){ .doc-shot align=left }
![IASO side menu](./iaso_mobile_attachments/iasomenuEN.png){ .doc-shot align=left }

- From the Project page, click on the QR code at the end of the corresponding line.
![Project QR code](./iaso_mobile_attachments/qrcodeiasoEN.png){ .doc-shot align=center }
- Scan the QR code with the IASO mobile application.
![Scan QR code step 1](./iaso_mobile_attachments/iasoqrcodeEN1.png){ .doc-shot-phone align=left }
![Scan QR code step 2](./iaso_mobile_attachments/iasoqrcodeEN2.png){ .doc-shot-phone align=left }
- It's ready!
...
![Mobile app buttons overview](./iaso_mobile_attachments/mobileappbuttons.png){ .doc-shot-lg align=center }
...
![Data collection screens](./iaso_mobile_attachments/datacollection.png){ .doc-shot-lg align=center }
...
![Upload collected data](./iaso_mobile_attachments/uploaddata.png){ .doc-shot-phone align=center }
...
![Send to server](./iaso_mobile_attachments/sendserver.png){ .doc-shot-phone align=center }
