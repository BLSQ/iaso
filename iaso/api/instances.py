    ...
    def list_file_export(filters: Dict[str, Any], queryset: "QuerySet[Instance]", file_format: FileFormatEnum):
        ...
        def get_row(instance, **kwargs):
            ...
            instance_values = [
                ...
                idict.get("export_id"),
                org_unit.get("latitude") if not idict.get("latitude") else idict.get("latitude"),
                org_unit.get("longitude") if not idict.get("longitude") else idict.get("longitude"),
                org_unit.get("altitude") if not idict.get("altitude") else idict.get("altitude"),
                idict.get("accuracy"),
                idict.get("period"),
                created_at,
                updated_at,
