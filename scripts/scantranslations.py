...
with open('./hat/assets/js/apps/Iaso/domains/app/translations/extracted/missingKeys'+sys.argv[3]+'.txt','w') as missing_keys_output_file:
    missing_keys_output_file.write("Missing keys: \n")
    for key in missing_keys:
        missing_keys_output_file.write(key+" \n")


with open('./hat/assets/js/apps/Iaso/domains/app/translations/extracted/unusedKeys'+sys.argv[3]+'.txt','w') as unused_keys_output_file:
