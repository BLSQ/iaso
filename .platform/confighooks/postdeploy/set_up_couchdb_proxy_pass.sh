...
################################################################################
# Note: this is the exact same file as in the .platform/hooks folder.
# The script in confighooks is executed upon deploy. This file is executed on 
# configuration changes such as changing ENV variables. 
